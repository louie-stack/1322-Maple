...
const playHorrorScream = () => {
  try {
    ...
    // Main volume envelope: Startlingly loud attack, decays like a dissipating spirit
    const mainGain = ctx.createGain();
    mainGain.gain.setValueAtTime(0, t);
    mainGain.gain.linearRampToValueAtTime(1.0, t + 0.01); 
    mainGain.gain.exponentialRampToValueAtTime(0.001, t + 1.2);
    
    // Harsh Scream Component: Dissonant, gliding oscillators
    const osc1 = ctx.createOscillator();
    osc1.type = 'sawtooth';
    osc1.frequency.setValueAtTime(800, t);
    osc1.frequency.exponentialRampToValueAtTime(2800, t + 0.1); // Shrieking rise
    osc1.frequency.exponentialRampToValueAtTime(400, t + 1.0);  // Dying fall
    ...
    // High-frequency jitter LFO for "fear shivering" effect
    ...
    // Ghostly Component: Harsh white noise through a resonance filter
    ...
    // Resonant "Bell of Death" ring for extra horror flavor
    ...
    // Graceful failure if blocked by browser
  }
};
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // 7-second interval for 160ms subliminal flash
  ...
  useEffect(() => {
    const handleGlobalClick = (e: MouseEvent) => {
      ...
      // Triggers harsh horror scream on any CTA button click
